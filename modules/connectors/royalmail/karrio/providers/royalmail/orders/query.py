...
import karrio.schemas.royalmail.order_details_response as order_details_res
import karrio.schemas.royalmail.order_info_response as order_info_res
import karrio.schemas.royalmail.orders_details_response as orders_details_res
import karrio.schemas.royalmail.orders_response as orders_res
import karrio.schemas.royalmail.return_services_response as return_services_res
import karrio.schemas.royalmail.version_response as version_res
...
def _parse_error_message(
    ...
    """Extract a readable message from a Click & Drop order error payload."""
...
def _get_first_value(payload: typing.Any, *names: str):
    """Read the first available key from a dict payload."""
...
def order_lookup_request(
    ...
    """Build a Click & Drop order lookup request from an identifier."""
    reference = (
        None
...
def orders_lookup_request(
    ...
    """Build a Click & Drop order list/details query request."""
...
def parse_get_order_response(
    ...
    """Parse a Click & Drop single-order response."""
...
def parse_get_order_details_response(
    ...
    """Parse a Click & Drop order details response."""
    response = _response.deserialize()
    messages = error.parse_error_response(
        response,
        settings,
...
def parse_list_order_details_response(
    ...
    """Parse a Click & Drop list order-details response."""
    response = _response.deserialize()
    messages = error.parse_error_response(
        response,
        settings,
...
def parse_get_return_services_response(
    ...
    """Parse Click & Drop return-services response metadata."""
    response = _response.deserialize()
    messages = error.parse_error_response(
        response,
        settings,
...
def parse_get_version_response(
    ...
    """Parse the Click & Drop version response."""
    response = _response.deserialize()
    messages = error.parse_error_response(
        response,
        settings,
