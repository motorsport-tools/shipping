...
import karrio.schemas.royalmail.error_response as generic_error
import karrio.schemas.royalmail.label_error_response as label_error
import karrio.schemas.royalmail.manifest_error_response as manifest_error
...
def _message(
    ...
    """Return a readable message string for an error value."""
...
def _is_error_item(item: typing.Any) -> bool:
    """Return whether a payload item looks like an error object."""
...
def _serialise_fields(fields: typing.Iterable[dict]) -> typing.List[dict]:
    """Serialize nested validation fields into readable text."""
    return [
        {
...
def _field_issue_message(
    ...
    """Build a readable message for one validation field issue."""
    if not field_name:
        return None
...
def _compose_field_message(
    ...
    """Build a message for one named validation field."""
...
def _compose_fields_summary_message(
    ...
    """Summarize validation field errors for Karrio messages."""
    field_names = [
        field.get("fieldName")
        for field in (fields or [])
        if isinstance(field, dict) and field.get("fieldName")
...
def _parse_generic_error_dict(
    ...
    **kwargs,
    ...
    """Parse a generic Click & Drop error dictionary."""
...
def _parse_order_error_item(
    ...
    **kwargs,
    ...
    """Parse a per-order Click & Drop error item."""
...
def _parse_error_collection(
    ...
    **kwargs,
    ...
    """Parse a list or mapping of carrier errors."""
...
def _parse_failed_orders(
    ...
    **kwargs,
    ...
    """Parse failedOrders entries from Click & Drop responses."""
    messages: typing.List[models.Message] = []
...
def parse_tracking_error_response(
    ...
    **kwargs,
    ...
    """Parse Royal Mail Tracking API error payloads into Karrio messages."""
...
def parse_error_response(
    ...
    **kwargs,
    ...
    """Parse Click & Drop error responses into Karrio messages."""
    messages: typing.List[models.Message] = []
