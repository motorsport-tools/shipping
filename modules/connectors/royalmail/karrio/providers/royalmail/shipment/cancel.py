...
import karrio.schemas.royalmail.cancel_response as cancel_res


def _extract_order_identifiers(
    payload: models.ShipmentCancelRequest,
) -> typing.Tuple[typing.Any, bool]:
    """Normalize cancellation order identifiers from the Karrio request."""
...
def parse_shipment_cancel_response(
    ...
    """Parse a Click & Drop cancellation response into a Karrio confirmation."""
...
def shipment_cancel_request(
    ...
    """Build the Click & Drop order cancellation request payload."""
