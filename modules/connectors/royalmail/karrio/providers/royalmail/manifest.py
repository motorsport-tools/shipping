...
import karrio.schemas.royalmail.manifest_async_response as manifest_async_res
import karrio.schemas.royalmail.manifest_details_response as manifest_details_res
import karrio.schemas.royalmail.manifest_request as manifest_req
import karrio.schemas.royalmail.manifest_response as manifest_res
...
def _parse_error_message(
    ...
    """Extract a readable message from a manifest error payload."""
...
def _normalize_status(status: typing.Optional[str], has_document: bool) -> str:
    """Normalize Royal Mail manifest status text into Karrio status values."""
    if status:
...
def _extract_details(
    ...
    """Extract manifest identifiers and status details from the response payload."""
